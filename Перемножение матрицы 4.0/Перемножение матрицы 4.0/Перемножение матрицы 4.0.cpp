...
// Перемножение матрицы 4.0.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CПеремножениематрицы40App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CПеремножениематрицы40App

CПеремножениематрицы40App::CПеремножениематрицы40App()
{
...
// Единственный объект CПеремножениематрицы40App

CПеремножениематрицы40App theApp;

const GUID CDECL BASED_CODE _tlid =
		{0x0b636c6a,0x41ca,0x4ccb,{0xa3,0x39,0xa8,0x45,0x77,0x8c,0xbb,0x43}};
const WORD _wVerMajor = 1;
const WORD _wVerMinor = 0;


// Инициализация CПеремножениематрицы40App

BOOL CПеремножениематрицы40App::InitInstance()
{
...
int CПеремножениематрицы40App::ExitInstance()
{
	AfxOleTerm(FALSE);
