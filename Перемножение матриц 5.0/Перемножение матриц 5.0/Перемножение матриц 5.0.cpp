...
// Перемножение матриц 5.0.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CПеремножениематриц50App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CПеремножениематриц50App

CПеремножениематриц50App::CПеремножениематриц50App()
{
...
// Единственный объект CПеремножениематриц50App

CПеремножениематриц50App theApp;


// Инициализация CПеремножениематриц50App

BOOL CПеремножениематриц50App::InitInstance()
{
